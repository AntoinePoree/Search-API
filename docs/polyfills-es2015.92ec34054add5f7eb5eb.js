    ...
    pDpN: function(e, t) {
              ...
              try {
                ...
                e.state !== k &&
                  ...
                  (e.type == S || (e.data && e.data.isPeriodic)
                    ...
                    : ((e.runCount = 0), this._updateTaskCount(e, -1), o && e._transitionTo(k, v, k))),
                  (P = P.parent),
                  (O = r);
              }
            }
          ...
          function v(e, o, s) {
            ...
            if (null === e[d]) {
              ...
              if (!1 !== o && s instanceof Z && s.hasOwnProperty(d) && s.hasOwnProperty(g) && null !== s[d])
                ...
                const a = e[g];
                if (
                  ((e[g] = s), e[_] === _ && !0 === o && ((e[d] = e[k]), (e[g] = e[m])), !1 === o && s instanceof Error)
                ) {
          ...
          (s.set = function(t) {
            ...
            n || e !== d || (n = d),
              n &&
                ...
                c && c.apply(n, g),
                'function' == typeof t ? ((n[u] = t), n.addEventListener(l, w, !1)) : (n[u] = null));
          }),
          (s.get = function() {
            let n = this;
      ...
      function Y(e, t, n) {
        return (
          ...
          n.configurable ||
            (e[V] || Object.isFrozen(e) || $(e, V, { writable: !0, value: {} }), e[V] && (e[V][t] = !0)),
          n
        );
      }
      function K(e, t, n, o) {
            ...
            (n.args[0] = function() {
              try {
                ...
                (t.data && t.data.isPeriodic) ||
                  ('number' == typeof n.handleId ? delete i[n.handleId] : n.handleId && (n.handleId[pe] = null));
              }
            }),
                ...
                'number' == typeof r ? (s = i[r]) : ((s = r && r[pe]), s || (s = r)),
                  s && 'string' == typeof s.type
                    ? 'notScheduled' !== s.state &&
                      ...
                      ('number' == typeof r ? delete i[r] : r && (r[pe] = null), s.zone.cancelTask(s))
                    : t.apply(e, o);
              }
          ));
      }
